...
function parseResults(stdout) {
  ...
  // win32 may EventLog.log data which need to filter out invalid JSON at start of results
  //TODO: do we need to filter out any EventLog.log data as we are expecting only valid json
  // any EventLog.log used for dedugging may break parseResults
