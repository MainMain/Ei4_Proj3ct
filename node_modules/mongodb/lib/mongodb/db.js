...
function Db(databaseName, serverConfig, options) {
  ...
  if(this.options.safe == null && this.options.w == null && this.options.journal == null && this.options.fsync == null) {
    ...
    EventLog.log("=        no write acknowlegement                                                       =");
    EventLog.log("=     journal: true/false, wait for flush to journal before acknowlegement             =");
    EventLog.log("=     fsync: true/false, wait for flush to file system before acknowlegement           =");
    EventLog.log("=                                                                                      =");
    ...
    EventLog.log("=                                                                                      =");
    EventLog.log("=  The default of no acknowlegement will change in the very near future                =");
    EventLog.log("=                                                                                      =");
