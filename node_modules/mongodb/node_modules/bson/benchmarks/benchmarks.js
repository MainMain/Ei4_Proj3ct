...
EventLog.log("====================== " + (new Date().getTime() -  s.getTime()) + " :: " + ((new Date().getTime() -  s.getTime()))/numberOfObjects)
...
// 
// EventLog.log(COUNT + "x (objectBSON = BSON.serialize(object))")
// start = new Date
// 
...
// EventLog.log("bson size (bytes): ", objectBSON.length);
// EventLog.log("time = ", end - start, "ms -", COUNT / ((end - start)/1000), " ops/sec");
// EventLog.log("MB/s = " + ((opsprsecond*objectBSON.length)/1024));
// 
