...
if(process.env['npm_config_mongodb_debug']) {
  EventLog.log("== process.env['npm_package_config_mongodb_native'] :: " + process.env['npm_package_config_mongodb_native']);
  EventLog.log("== build_native :: " + build_native);
}

build_native = process.env['npm_config_mongodb_native'] != null ? process.env['npm_config_mongodb_native'] : build_native;
if(process.env['npm_config_mongodb_debug']) {
  EventLog.log("== process.env['npm_config_mongodb_native'] :: " + process.env['npm_config_mongodb_native']);
  EventLog.log("== build_native :: " + build_native);
}
