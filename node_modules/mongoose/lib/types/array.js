 ...
 *      EventLog.log(popped); // 3
 *      EventLog.log(doc.array); // [1,2]
 *
 *      // no affect
 ...
 *        popped = doc.array.$pop();
 *        EventLog.log(popped); // 2
 *        EventLog.log(doc.array); // [1]
 *      })
 *
 * @api public
 * @method $pop
 ...
 *      EventLog.log(shifted); // 1
 *      EventLog.log(doc.array); // [2,3]
 *
 *      // no affect
 ...
 *        shifted = doc.array.$shift();
 *        EventLog.log(shifted ); // 2
 *        EventLog.log(doc.array); // [3]
 *      })
 *
 * @api public
 * @memberOf MongooseArray
 ...
 * ####Example:
 *
 *     EventLog.log(doc.array) // [2,3,4]
 *     var added = doc.array.addToSet(4,5);
 *     EventLog.log(doc.array) // [2,3,4,5]
 *     EventLog.log(added)     // [5]
 *
 * @param {any} [args...]
 ...
 *
 *     doc.array.set(1,"5");
 *     EventLog.log(doc.array); // [2,5,4] // properly cast to number
 *     doc.save() // the change is saved
 *
 *     // VS not using array#set
 *     doc.array[1] = "5";
 *     EventLog.log(doc.array); // [2,"5",4] // no casting
