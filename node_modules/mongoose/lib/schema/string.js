 ...
 *     EventLog.log(m.email) // someemail@example.com
 *
 * @api public
 * @return {SchemaType} this
 */
 ...
 *     EventLog.log(m.caps) // AN EXAMPLE
 *
 * @api public
 * @return {SchemaType} this
 */
 ...
 *     EventLog.log(string.length) // 11
 *     var m = new M({ name: string })
 *     EventLog.log(m.name.length) // 9
 *
 * @api public
 * @return {SchemaType} this
 */
 ...
 *     m.validate(function (err) {
 *       EventLog.log(String(err)) // "ValidationError: That file doesn't end in .html (invalid)"
 *     })
 *
