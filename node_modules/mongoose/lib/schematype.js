 ...
 *     var M = db.model('M', schema)
 *     var m = new M;
 *     EventLog.log(m.aNumber) // 4.815162342
 *
 ...
 *     var m1 = new M;
 *     m1.mixed.added = 1;
 *     EventLog.log(m1.mixed); // { added: 1 }
 *     var m2 = new M;
 *     EventLog.log(m2.mixed); // { added: 1 }
 *
 ...
 *     EventLog.log(user.email); // 'avenue@q.com'
 *
 *     // or
 *     var user = new User
 ...
 *
 *     EventLog.log(v.name);     // name is required
 *     EventLog.log(v.taxonomy); // Parvovirinae
 *
 * @param {Function} fn
 * @return {SchemaType} this
 * @api public
 ...
 *       EventLog.log(found.creditCardNumber); // '****-****-****-1234'
 *     });
 *
 ...
 *       EventLog.log(virus.name);     // name is required
 *       EventLog.log(virus.taxonomy); // taxonomy is not
 *     })
 *
 * @param {Function} fn
 * @return {SchemaType} this
