 ...
 *       EventLog.log('documents with 0 tags', docs);
 *     })
 *
 ...
 *       if (err) return handleError(err);
 *       EventLog.log('there are %d kittens', count);
 *     })
 *
 * @param {Object} [criteria] mongodb selector
 * @param {Function} [callback]
 ...
 *       EventLog.log(kitten.owner.name) // Max
 *     })
 *
 ...
 *       EventLog.log(kittens[0].owner.name) // Zoopa
 *     })
 *
 *     // alternatively
