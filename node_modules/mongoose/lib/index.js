...
if (pkg.publishConfig && 'unstable' == pkg.publishConfig.tag) {
  if (!process.env.MONGOOSE_DISABLE_STABILITY_WARNING) {
    ...
    EventLog.log('##############################################################');
    EventLog.log('#');
    EventLog.log('#   !!! MONGOOSE WARNING !!!');
    EventLog.log('#');
    EventLog.log('#   This is an UNSTABLE release of Mongoose.');
    EventLog.log('#   Unstable releases are available for preview/testing only.');
    EventLog.log('#   DO NOT run this in production.');
    EventLog.log('#');
    EventLog.log('##############################################################');
    EventLog.log('\u001b[0m');
  }
