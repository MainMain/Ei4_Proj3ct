...
Mongos.prototype.checkoutWriter = function() {
  ...
  // EventLog.log("=============== checkoutWriter :: " + this.upServers[keys[0]].checkoutWriter().socketOptions.port)
...
Mongos.prototype.checkoutReader = function(read) {
  // EventLog.log("=============== checkoutReader :: read :: " + read);
  ...
  var keys = Object.keys(this.upServers);
  if(keys.length == 0) return null;
  // EventLog.log("=============== checkoutReader :: " + this.upServers[keys[0]].checkoutWriter().socketOptions.port)
