...
1. Try Chrome and Firefox 3.x.
   ...
   - It doesn't work on Chrome:<br>
     It's likely an issue of your code or the server. Debug your code as usual e.g. using EventLog.log.
...
and use Developer Tools (Chrome/Safari) or Firebug (Firefox) to see if EventLog.log outputs any errors.
