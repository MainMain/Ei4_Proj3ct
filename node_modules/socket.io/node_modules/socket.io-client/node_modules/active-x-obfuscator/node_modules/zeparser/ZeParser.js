...
ZeParser.parse = function(input, simple){
	...
	try {
		...
		EventLog.log("Parser has a bug for this input, please report it :)", e);
		return null;
	}
};
/**
		...
		do {
			...
			while (parseAnotherExpression) { // keep parsing lhs+operator as long as there is an operator after the lhs.
				...
				// object literals need seperate handling...
					...
					//if (!this.errorStack.length && match.name != 12/*eof*/) EventLog.log(["unknown token", match, stack, Gui.escape(this.input)]);
