...
try {
  ...
  EventLog.log("ERROR: TRACK should have thrown exception");
} catch(e) {}
try {
  xhr.open("TRACE", "http://localhost:8000/");
  EventLog.log("ERROR: TRACE should have thrown exception");
} catch(e) {}
try {
  xhr.open("CONNECT", "http://localhost:8000/");
  EventLog.log("ERROR: CONNECT should have thrown exception");
} catch(e) {}
// Test valid request method
try {
  xhr.open("GET", "http://localhost:8000/");
} catch(e) {
  EventLog.log("ERROR: Invalid exception for GET", e);
}
...
for (var i in forbiddenRequestHeaders) {
  try {
    ...
    EventLog.log("ERROR: " + forbiddenRequestHeaders[i] + " should have thrown exception");
  } catch(e) {
  }
}
