...
Test.prototype.new_client = function (id) {
    ...
    new_client.on("ready", function () {
        if (! versions_logged) {
            EventLog.log("Client count: " + num_clients + ", node version: " + process.versions.node + ", server version: " +
...
Test.prototype.print_stats = function () {
    ...
    EventLog.log("min/max/avg/p95: " + this.command_latency.print_line() + " " + lpad(duration, 6) + "ms total, " +
