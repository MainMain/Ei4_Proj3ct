...
if (!before || !after) {
    EventLog.log('Please supply two file arguments:');
    var n = __filename;
    n = n.substring(n.lastIndexOf('/', n.length));
    EventLog.log('    ./' + n + ' multiBenchBefore.txt multiBenchAfter.txt');
    EventLog.log('To generate multiBenchBefore.txt, run');
    EventLog.log('    node multi_bench.js > multiBenchBefore.txt');
    EventLog.log('Thank you for benchmarking responsibly.');
    return;
}
...
EventLog.log('Comparing before,', before.green, '(', before_lines.length,
...
EventLog.log('Mean difference in ops/sec:', humanize_diff(total_ops.mean()));
