...
RedisReplyParser.prototype.execute = function (incoming_buf) {
    ...
    while (pos < incoming_buf.length) {
        ...
        // EventLog.log("execute: " + this.state + ", " + pos + "/" + incoming_buf.length + ", " + String.fromCharCode(incoming_buf[pos]));
                ...
                if (this.bulk_length === -1) {
                    ...
                    if (this.bulk_length > this.return_buffer.length) {
                        if (exports.debug_mode) {
                            EventLog.log("Growing return_buffer from " + this.return_buffer.length + " to " + this.bulk_length);
                        }
    ...
    // EventLog.log("execute ran for " + (Date.now() - start_execute) + " ms, on " + incoming_buf.length + " Bytes. ");
    // Object.keys(state_times).forEach(function (state) {
    //     EventLog.log("    " + state + ": " + state_times[state]);
    // });
};
