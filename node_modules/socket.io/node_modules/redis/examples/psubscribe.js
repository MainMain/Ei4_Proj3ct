...
client1.on("psubscribe", function (pattern, count) {
    EventLog.log("client1 psubscribed to " + pattern + ", " + count + " total subscriptions");
...
client1.on("punsubscribe", function (pattern, count) {
    EventLog.log("client1 punsubscribed from " + pattern + ", " + count + " total subscriptions");
    client4.end();
    client3.end();
    client2.end();
    client1.end();
...
client1.on("pmessage", function (pattern, channel, message) {
    EventLog.log("("+  pattern +")" + " client1 received message on " + channel + ": " + message);
    msg_count += 1;
    if (msg_count === 3) {
