...
function write_file(commands, path) {
    ...
    EventLog.log("Writing " + Object.keys(commands).length + " commands to " + path);
...
http.get({host: "redis.io", path: "/commands.json"}, function (res) {
    ...
    EventLog.log("Response from redis.io/commands.json: " + res.statusCode);
    ...
    EventLog.log("Error fetching command list from redis.io: " + e.message);
});
